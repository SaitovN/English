...
import static com.example.optimo.MainActivity.list;
   ...
   LinearLayout nextBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        countDownTimer=new CountDownTimer(20000,1000) {
            ...
            Dialog dialog =new Dialog(layout.this);
    ...
    private void GameWon(){
        Intent intent = new Intent(layout.this,WonActivity.class);
        intent.putExtra("correct",correctCont);
